...
cp -r fonts/Lato-Regular.ttf ${TARGET_DIR}/python/mxnet/Lato-Regular.ttf 
if [[ $OSTYPE == linux* ]]; then
...
tar -czvf ${FNAME} mxnet/*.py mxnet/builtin_symbols mxnet/utils mxnet/module libmxnet* mxnet/Lato-Regular.ttf
echo "====================================="
}
